...
const DiscountSchedule = () => {
  ...
  return (
    ...
    <div className="w-[838px] pt-6 bg-white rounded-3xl">
      {/* Title */}
      

      {/* Main Content Area */}
      <div className="px-6 pb-6 gap-[7px] ">
          ...
          <div className="border-black/50">
            <div className="flex w-full">
              {days.map((day, index) => (
                ...
                >
                  <div className={`
                    w-8 h-8 mb-1 flex items-center justify-center text-xs text-[#364A15]
                    ${index === activeDayIndex ? 'rounded-full bg-[#D2F4D6]' : ''}
                    hover:bg-[#D2F4D6]/50 rounded-full transition-colors relative
                  `}>
                    {day.day}
                    {/* Single continuous line from the date circle */}
            ...
            <div className="relative  h-[160px]">
              ...
              <div className="absolute top-0 left-0 right-[30%] h-7">
                <div className="h-full rounded-full bg-gradient-to-r from-[#ffffff] via-[#D2F4D6] to-[#bbf1c2]">
                  <span className="absolute left-14  top-1/2 -translate-y-1/2 text-[14px] text-[#364A15]">
                    Blue Bird coupon
                  </span>
                </div>
              </div>
              ...
              <div className="absolute top-[60px] left-[40%] right-0 h-7">
                <div className="h-full rounded-full bg-gradient-to-r from-[#bef5c4] via-[#D2F4D6] to-transparent">
                  <span className="absolute right-14 top-1/2 -translate-y-1/2 text-[14px] text-[#364A15]">
                    Buy one get one free
                  </span>
                </div>
              </div>
              ...
              <div className="absolute top-[120px] left-[25%] right-[25%] h-7">
                <div className="h-full rounded-full bg-[#D2F4D6]">
                  <span className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 text-[14px] text-[#364A15]">
