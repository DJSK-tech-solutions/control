...
const TimeframeFilterInvoice = () => {
  ...
  const [selectedTag, setSelectedTag] = useState('Order Invoice');
    ...
    <div className="flex items-center justify-between">
      <div className="flex items-center gap-3">
        ...
        <Popover>
          ...
          <PopoverContent className="w-[423px] h-[740.03px] p-4 bg-white" align="start">
            <div className="space-y-4 ">
                ...
                <div className="flex gap-2">
                  {years.map(year => (
                    <button
                      ...
                      className={`px-4 py-1.5 rounded-full text-sm ${selectedYear === year
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`px-4 py-1.5 rounded-full text-sm ${selectedStatus === 'Draft' ? 'bg-green-50 text-green-700 ring-1 ring-green-600' : 'border border-gray-500'}`}
                  >
                    Draft
                  </button>
                  <button
                    onClick={() => setSelectedStatus('Paid')}
                    className={`px-4 py-1.5 rounded-full text-sm ${selectedStatus === 'Paid' ? 'bg-green-50 text-green-700 ring-1 ring-green-600' : 'border border-gray-500'}`}
                  >
                    Paid
                  </button>
                </div>
              ...
              <div className="space-y-3">
                ...
                <select
                  ...
                  className="px-5 py-1 justify-items-center rounded-full text-sm border border-gray-500"
                >
                  <option value="Order Invoice">Order Invoice</option>
                  <option value="Other">Monthly Invoice</option>
...
export default TimeframeFilterInvoice;